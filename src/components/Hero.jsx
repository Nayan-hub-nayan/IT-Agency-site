...
const Hero = () => {
  return (
    <div className="relative min-h-screen w-full flex flex-col overflow-hidden bg-mesh font-display antialiased text-white">
      <header className="p-8 flex justify-between items-start z-20">
        ...
        <div className="flex gap-4 items-center">
          <div className="px-4 py-1.5 border border-white/20 rounded-full text-[10px] tracking-widest uppercase font-mono">
            About Us
          </div>
      ...
      <main className="flex-1 grid grid-cols-12 gap-6 px-8 relative z-10">
        <div className="col-span-12 lg:col-span-4 flex flex-col justify-start pt-12">
          <div className="bg-white/5 backdrop-blur-md p-8 rounded-[40px] border border-white/10 relative overflow-hidden group">
            ...
            <a className="w-16 h-16 rounded-full bg-accent flex items-center justify-center group-hover:scale-110 transition-transform duration-300" href="#">
              <span className="material-icons text-background-dark font-bold text-black">arrow_forward</span>
            </a>
          </div>
