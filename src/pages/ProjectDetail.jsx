...
const getProjectData = (id) => {
  const defaultData = {
    id: id || 'UNKNOWN',
    name: 'NEURAL INTERFACE_X',
    year: '2024',
    desc: 'A decentralized visualization engine for real-time biometric data processing across distributed edge networks.',
    imgMain: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBNDTnRaYwtMHlPHzs9TJlBbbr2_EH3fqEA1IokwcF9Q_XiXdLtQrl7XHgTC1pZTjUo_-64Xg3KRegPiCF-n6WQMTJd9mCG36TDFDc4ZU2CvojmuoXJFKsmGkEkKJ9-1k7U0oRSXs0MAAGYiiVyBX794u14GbD2tkT95u9bipgHbOr-APhG3cYbtRM2Aptkasfc6iN81m3RNLltLj89xFtCeoeVuIUyPaeghffr_W6jsAUJohuTWx17qO7L8c4jJKP_k1FjcW6YK-rD',
    imgSub1: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBPBhbfz_xYtWXKshFq5ESFKyy-ZGPHkFWdgG3lMQi3qFRJT2aUlUUgiqcmjcHFRgSfYvKegBOWkydTX06pS5PZxfaop2Dtp4p25Fr5omPDWcSCWnJxd5T7eixOkYesbWFUsAybcTb5v1mkZdxTfwusrDpcRkJng4yR0iJ5hdVEgUSkFCNabTxyK6kqcIeAywBCakD3bFMqygmDRH2sZ2U7HV_QiUWP7p1MLpoeHhCKWUGQv7aigFsCD82HwToi4yswJon_mYfsScdq',
    imgSub2: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCna8dQakiM4NeoWSaORey5QCaCwyCk9akrzFZX56-yf7yN4yGlYbvUcAe8imZYUFhk5VkcJY1pH-UmddMUCy2CkeFP37DbYUrtKscAom16uUpK8s5ZUuxkeb1adYjJ3b1IUae3MJYiaQQbv-s3wdsLSbvviYi1XB3w_NqCMTS11RlaX8kheJfbCeWyhJMZJ5JX74l0dZHeLvzkTyPG3DsgIJNY3PnzROofb_pTyAawzLaKULpmS43lnVW2nYJE7Cn0m00livycv--p',
    missionDesc: 'We architected a high-fidelity visualization platform capable of rendering 1.2M concurrent data points with sub-10ms latency. The solution utilizes a custom WebGL engine wrapped in a decentralized node architecture to ensure maximum uptime and security for high-stakes biometric monitoring.',
    stack: ['React_v18', 'Three.js', 'Rust_WASM', 'GraphQL_Nodes', 'Tailwind_Engines'],
    engagement: '88%',
    likes: '12.4k',
    shares: '3.2k',
    clientQuote: '"The NEURAL_INTERFACE_X has completely redefined how our analysts interact with raw node data. The speed of the WebGL rendering is unprecedented in our sector."',
    clientImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBEt8t64WNqlCii82z9M4jx4Gy1BuKOGeIZfgc4PKBlEm7j6DH5Av6onUKSzdKklp0_7REspRWtWFKcJRp7mwW5tdONP0UG9lq7q9_pDmhiuvbQl7qqI5lqB_Z4B4m8hnvsFtB3r9eKpnH-uhSKFe3xyMxBiTsEdVgCDHYkc3iqI9G5n7-6Ey661_oxDvFCQ7HXV45uVcWcXNEkMvsGndgsNaf9PMfX3IIvzAQl6qpT4OMgrUN6hw_TmK5-wPYo4pjUcNujuAxuV-hF',
    clientName: 'Marcus_Vane.exe',
    clientRole: 'CTO // Cyberdyne Systems',
    videoThumb: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCbdp_z8-wHnJ_w-lsvvZp5CFph0vnuUHYIwG1SuZ59I_7q35ILg-8lE_W67-k5VL8H8hTgTq1R1DWceXZXHVk-FbvLkoAYPbdgvOfzAyvdWu2JJXuZsNQ2OGG_DQYZp0oib6kbNPHQIbRwuu5BmYe5OSHX95lTJDChDF40-UZ2ocpecmS9Jq70FARn8Wt47lzzgqsrmmVwI1asLEiiYSBAJYaAN_BOQoVowO76sMjDtoFCE41sz36v6s_dVaxML8Rs3xiLocLnE_4Z',
