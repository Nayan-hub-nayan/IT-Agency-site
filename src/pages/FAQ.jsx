...
const FAQ = () => {
  return (
    <div className="min-h-screen bg-background-dark text-slate-100 overflow-x-hidden relative selection:bg-accent selection:text-white">
      ...
      {/* Header Info */}
      <header className="relative z-10 p-8 flex justify-between items-start border-b border-white/5 bg-black/40 backdrop-blur-md pt-32">
        <div className="space-y-2">
          <div className="text-[10px] font-mono tracking-[0.4em] text-slate-500 uppercase font-black">(N°042) FAQ SYSTEM</div>
          <div className="flex items-center gap-3">
            <div className="w-12 h-[2px] bg-neon-green shadow-[0_0_10px_#39FF14]"></div>
            <span className="text-[9px] font-mono text-neon-green tracking-widest uppercase font-black">Operational since 2018</span>
          </div>
        </div>
        <div className="flex flex-col items-end gap-3">
          <div className="flex items-center gap-6">
            <span className="text-[9px] font-mono text-slate-500 font-light">40.7440° N 73.9873° W</span>
            <motion.button 
          ...
          <span className="text-[9px] font-mono text-slate-400 tracking-[0.5em] font-black uppercase">ELUNA // STUDIO</span>
        </div>
      </header>
